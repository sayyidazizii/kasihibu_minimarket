                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" style="width: 50%" name="purchase_return_date" id="purchase_return_date" type="date" data-date-format="dd-mm-yyyy" autocomplete="off" onchange="function_elements_add(this.name, this.value)" value="{{ $datases['purchase_return_date'] ? $datases['purchase_return_date'] : date('Y-m-d') }}"/>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
